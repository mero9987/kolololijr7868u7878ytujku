...
local f = io.open("./ledarbot.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./ledarbot.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,bot_id,1751198705,0000000000,0000000000,0000000000}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'القائد'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "theleader205")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇SOURCE The leader")  
...
{'المشتركين ※','الجروبات ※'},
{'ضع كليشه المطور ※','مسح كليشه المطور ※'},
...
if text == 'ديف اسلام' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/theleader205)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/theleader205"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل سورس', url="t.me/Source205bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ※ العضو » ['..result.title_..'](t.me/'..(username or 'theleader205')..')'
status  = '\n ※ تم ترقيته مطور'
...
usertext = '\n ※ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
status  = '\n ※ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'theleader205')..') \n ※ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ※ العضو : {["..data.first_name_.."](T.ME/theleader205)}\n ※ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ※ عذرا » {["..data.first_name_.."](T.ME/theleader205)}\n ※ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس',url="t.me/C_V205"}}, 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مبرمج السورس',url="t.me/C_V205"}},
{{text = 'تواصل سورس', url="t.me/Source205bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ديف اسلام', url="t.me/C_V205"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'الالعاب' or text == 'العاب متطوره' then
local Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ※ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'theleader205')..') \n ※ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'theleader205')..') \n ※ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1751198705) then
send(msg.chat_id_, msg.id_, " ※ لا يمكنك حظر المطور اسلام\n")
return false 
end
if result.sender_user_id_ == tonumber(0000000000) then
...
if result.id_ == tonumber(1751198705) then
send(msg.chat_id_, msg.id_, " ※ لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n ※ العضو » ['..result.title_..'](t.me/'..(username or 'theleader205')..')'
...
if tonumber(userid) == tonumber(1751198705) then  
...
if result.sender_user_id_ == tonumber(0000000000) then
send(msg.chat_id_, msg.id_, " ※ لا يمكنك كتم المطور حودا\n")
return false 
end
if result.sender_user_id_ == tonumber(0000000000) then
...
if result.sender_user_id_ == tonumber(1751198705) then
send(msg.chat_id_, msg.id_, " ※ لا يمكنك كتم المطور اسلام\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/islam-2052/leader/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ※ اهلا بك في متجر ملفات القائد\n ※ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ The leader ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ The leader ┉  ┉ ┉ ┉ ┉≫ٴ\n ※ علامة تعني { ✔️ } ملف مفعل\n ※ علامة تعني { ✖ } ملف معطل\n ※ قناة سورس القائد ↓\n".." ※ [اضغط هنا لدخول](t.me/theleader205) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/islam-2052/leader/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ※ عذرا الملف لايدعم سورس القائد \n") 
end
return false
end
...
if text == ("مسح قائمه القائد") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ※ تم مسح قائمه القائد')
return false
end

if text == 'قائمه القائد' and Sudo(msg) then
...
if text == ("رفع القائد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع القائد @(.*)$") and Sudo(msg) then
local username = text:match("^رفع القائد @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع القائد (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع القائد (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل القائد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل القائد @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل القائد @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل القائد (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل القائد (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ※ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
status  = '\n ※ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ※ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ※ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ※ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'theleader205')..')'..'\n ※ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'القائد').."" then  
...
database:set(bot_id.."theleader205:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."theleader205:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."theleader205:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."theleader205:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"※تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."theleader205:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."theleader205:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس القائد يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'القائد').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
local iduser = result.sender_user_id_
...
{
{text = 'SOURCE The leader', url="t.me/theleader205"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ The leader ┉  ┉ ┉ ┉ ┉≫ٴٴ\n※ ➫ .[🖨┇SOURCE The leader ](t.me/theleader205)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'القائد')
